...
about: Stuck on a step in the install walkthrough?
title: "[install] "
labels: install-help
---
...
<!-- Paste the relevant section of your hermetiq-values.yaml or buildbarn-values.yaml.
     Replace secrets, real hostnames, and real project IDs with placeholders. -->
...
**Anything else?**
<!-- Logs from kubectl describe / kubectl logs, screenshots, etc. -->
